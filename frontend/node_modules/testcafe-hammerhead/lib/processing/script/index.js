...
function getAst(src, isObject) {
    ...
    try {
        return (0, _acornHammerhead.parse)(src, PARSER_OPTIONS);
    } catch (err) {
        return null;
    }
}
...
function isArrayDataScript(ast) {
    return ast.body.length === 1 && ast.body[0].type === _esotopeHammerhead.Syntax.ExpressionStatement && ast.body[0].expression.type === _esotopeHammerhead.Syntax.ArrayExpression;
}
