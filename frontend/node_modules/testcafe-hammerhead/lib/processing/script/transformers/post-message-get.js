...
exports.default = {
    ...
    condition: (node, parent) => {
        if (node.name === 'postMessage') {
            ...
            if (parent.type === _esotopeHammerhead.Syntax.CallExpression && (parent.callee.name === _instruction2.default.getPostMessage || parent.callee.name === _instruction2.default.callMethod && parent.arguments[1] === node)) return false;
