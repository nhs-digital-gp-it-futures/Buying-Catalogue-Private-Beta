...
exports.default = {
    ...
    run: node => {
        ...
        if (node.body.type !== _esotopeHammerhead.Syntax.BlockStatement) (0, _replaceNode2.default)(node.body, (0, _nodeBuilder.createBlockExprStmt)([assignmentExprStmt, node.body]), node, 'body');else (0, _replaceNode2.default)(null, assignmentExprStmt, node.body, 'body');
