...
exports.default = {
    ...
    condition: (node, parent) => {
        ...
        if (parent.type === _esotopeHammerhead.Syntax.CallExpression && parent.callee.name === _instruction2.default.getEval) return false;
        // window.eval
        if (node.property.type === _esotopeHammerhead.Syntax.Identifier && node.property.name === 'eval') return true;
        // window['eval']
