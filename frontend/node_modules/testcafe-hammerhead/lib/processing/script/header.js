...
const HEADER = `
    ...
    if (typeof window !== 'undefined' && window){
        window['${_internalProperties2.default.processDomMethodName}'] && window['${_internalProperties2.default.processDomMethodName}']();

        if (window.${_instruction2.default.getProperty} && typeof ${_instruction2.default.getProperty} === 'undefined') {
            var ${_instruction2.default.getLocation} = window.${_instruction2.default.getLocation},
                ${_instruction2.default.setLocation} = window.${_instruction2.default.setLocation},
                ${_instruction2.default.setProperty} = window.${_instruction2.default.setProperty},
                ${_instruction2.default.getProperty} = window.${_instruction2.default.getProperty},
                ${_instruction2.default.callMethod} = window.${_instruction2.default.callMethod},
                ${_instruction2.default.getEval} = window.${_instruction2.default.getEval},
                ${_instruction2.default.processScript} = window.${_instruction2.default.processScript},
                ${_instruction2.default.processHtml} = window.${_instruction2.default.processHtml},
                ${_instruction2.default.getPostMessage} = window.${_instruction2.default.getPostMessage};
        }
    } else {
        var ${_instruction2.default.getLocation} = function(l){return l},
            ${_instruction2.default.setLocation} = function(l,v){return l = v},
            ${_instruction2.default.setProperty} = function(o,p,v){return o[p] = v},
            ${_instruction2.default.getProperty} = function(o,p){return o[p]},
            ${_instruction2.default.callMethod} = function(o,p,a){return o[p].apply(o,a)},
            ${_instruction2.default.getEval} = function(e){return e},
            ${_instruction2.default.processScript} = function(s){return s},
            ${_instruction2.default.processHtml} = function(h){return h},
            ${_instruction2.default.getPostMessage} = function(w,p){return arguments.length===1?w.postMessage:p};
    }
