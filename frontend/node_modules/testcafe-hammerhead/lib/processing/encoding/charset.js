...
class Charset {
    ...
    fromContentType(contentTypeHeader) {
        if (this.priority <= CharsetPriority.CONTENT_TYPE) {
            ...
            return this.set((0, _labels2.default)(charset), CharsetPriority.CONTENT_TYPE);
        }
        return false;
    }
    fromUrl(charsetFromUrl) {
        if (charsetFromUrl && this.priority <= CharsetPriority.URL) return this.set((0, _labels2.default)(charsetFromUrl), CharsetPriority.URL);
        return false;
    }
    ...
    fromMeta(metas) {
        if (this.priority < CharsetPriority.META && metas.length) {
            ...
            return this.set((0, _labels2.default)(charsetStr), CharsetPriority.META);
        }
        return false;
    }
}
