...
const PSEUDO_CLASS_RE = new RegExp(`\\[${_internalAttributes2.default.hoverPseudoClass}\\](\\W)`, 'ig');
const IS_STYLE_SHEET_PROCESSED_RE = new RegExp(`\\s*${(0, _regexpEscape2.default)(STYLESHEET_PROCESSING_START_COMMENT)}`, 'gi');
const STYLESHEET_PROCESSING_COMMENTS_RE = new RegExp(`\\s*${(0, _regexpEscape2.default)(STYLESHEET_PROCESSING_START_COMMENT)}\n?|` + `\n?${(0, _regexpEscape2.default)(STYLESHEET_PROCESSING_END_COMMENT)}\\s*`, 'gi');
